...
| Carpeta | Tema |
|---|---|
| `01-fundamentos/` | Variables, tipos de datos, print, input |
| `02-operadores/` | Suma, comparación, lógica booleana |
| `03-control-de-flujo/` | if, for, while — tomar decisiones y repetir |
| `04-funciones/` | Organizar código en bloques reutilizables |
| `05-estructuras-de-datos/` | Listas, tuplas, diccionarios, conjuntos |
| `06-strings/` | Texto: métodos, formato, manipulación |
| `07-manejo-de-errores/` | Qué hacer cuando algo falla |
| `08-modulos/` | Reutilizar código entre archivos |
| `09-poo/` | Programación Orientada a Objetos |
| `10-archivos/` | Leer y escribir archivos, CSV, JSON |
| `11-nivel-intermedio/` | Comprensiones, generadores, decoradores |
| `12-proyecto-final/` | 🎯 Mini proyecto integrador: gestor de tareas |

### 🟡 Nivel Medio — Ecosistema Python

| Carpeta | Tema |
|---|---|
| `13-entorno-virtual-y-pip/` | venv, pip, requirements.txt — trabajo profesional |
| `14-python-avanzado/` | Type hints, dataclasses, itertools, functools |
| `15-testing/` | unittest, pytest, mocking — código confiable |
| `16-bases-de-datos/` | SQLite, SQLAlchemy — persistencia de datos |
| `17-web-scraping/` | requests, BeautifulSoup, Selenium — extraer datos web |
| `18-automatizacion/` | OS, email, scheduling, pyautogui — automatizar todo |
| `19-apis-rest/` | Consumir y construir APIs REST con Python |

### 🔴 Nivel Avanzado — Aplicaciones del mundo real

| Carpeta | Tema |
|---|---|
| `20-django/` | Django — el framework web más completo de Python |
| `21-fastapi/` | FastAPI — APIs modernas y asíncronas |
| `22-data-science/` | NumPy, Pandas, Matplotlib, Seaborn |
| `23-machine-learning/` | Scikit-learn — ML clásico de inicio a fin |
| `24-inteligencia-artificial/` | Deep Learning, NLP, APIs de IA (OpenAI, etc.) |
| `25-scripts-y-herramientas/` | CLI tools, argparse, Click, Rich, packaging |
